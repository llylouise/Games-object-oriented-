...
from SubtractSquareGame import SubtractSquareGame
from ChopsticksGame import ChopsticksGame

from strategy_solution import *
...
usable_strategies = {'r': random_strategy,
                     ...
                     'm': recursive_minimax_strategy,
                     't': iterative_minimax_strategy,
                     'a': recursive_minimax_alphabeta_strategy}
...
class GameInterface:
    ...
    def __init__(self, game, p1_strategy, p2_strategy):
        """
